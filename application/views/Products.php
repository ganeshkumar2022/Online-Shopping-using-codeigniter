...
<h4 class="bg-primary text-white p-3">Categories</h4>
...
foreach($category as $c)
{
	?>
  <li class="nav-item">
    <a class="nav-link text-dark text-decoration-none" href="<?=base_url('home/products?category_id='.$c->cid)?>"><?=$c->cname?></a>
  </li>
	<?php
}
?>
...
<h4 class="bg-primary text-white p-3">Brands</h4>
<ul class="nav flex-column">
<?php
foreach($brand as $b)
{
	?>
  <li class="nav-item">
    <a class="nav-link text-dark text-decoration-none" href="<?=base_url('home/products?brand_id='.$b->bid)?>"><?=$b->bname?></a>
  </li>
	<?php
}
?>
