...
<h3 class="text-center font-weight-bold my-3">Admin login</h3>
<div class="row" style="margin-top:50px;">
	<div class="col-md-6">
		<img src="<?=base_url('assets/images/p1.jpg')?>" class="mx-auto d-block" style="height:450px;">
	</div>
	<div class="col-md-6">
	<form action="<?=base_url('admin/check_login')?>" id="logform" class="mt-5" method="post" autocomplete="off">
